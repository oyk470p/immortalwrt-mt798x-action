...
sed -i "s/DISTRIB_REVISION='*.*'/DISTRIB_REVISION=' Designed By JDC-AX6000'/g" package/base-files/files/etc/openwrt_release
sed -i "s|^OPENWRT_RELEASE=\".*\"|OPENWRT_RELEASE=\"ImmortalWrt @R$(date +%Y%m%d)\"|" package/base-files/files/usr/lib/os-release
